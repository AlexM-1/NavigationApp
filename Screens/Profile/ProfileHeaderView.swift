...
private extension ProfileHeaderView {
    ...
    func configure() {
        ...
        publicationsLabel.text = "\(String(describing: user.publications)) \n публикаций"

//        publicationsLabel.text = String(format: "any_posts".localizable, user.publications)

        subscriptionsLabel.text = "\(String(describing: user.subscriptions)) \n подписок"
        subscribersLabel.text = "\(String(describing: user.subscribers.roundedWithAbbreviations)) \n подписчиков"
    }
